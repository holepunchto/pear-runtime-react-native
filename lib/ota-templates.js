...
function swiftBundleUrl(bundleRoot) {
  return `override func bundleURL() -> URL? {
    ...
    let otaBundleURL = documentDirectory.appendingPathComponent("pear-runtime/ota/app.bundle")
...
function objCBundleUrl(bundleRoot) {
  ...
  NSURL *otaURL = [docDir URLByAppendingPathComponent:@"pear-runtime/ota/app.bundle"];
